...
?>
	<body>
        ...
        ?>
			...
			<!-- Title Header Start -->
			<section class="inner-header-title" style="background-image:url(client/assets/img/bn2.jpg);">
				<div class="container">
					<h1>Login</h1>
				</div>
			</section>
...
<!-- Mirrored from codeminifier.com/job-stock-5.4.1/job-stock/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Oct 2021 06:58:47 GMT -->
</html>