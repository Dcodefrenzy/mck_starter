...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="banner trans" style="background-image:url(client/assets/img/slider-1.jpg);"  data-overlay="6">
            <div class="container">
                <div class="banner-caption">
                    <div class="col-md-12 col-sm-12 banner-text">
                        <h1> Browse Verified Online Brands</h1>
                        <div class="full-search-2 eclip-search italian-search hero-search-radius">
							<div class="hero-search-content">
								
								<div class="row">
								
									<div class="col-lg-9 col-md-9 col-sm-12 small-padd b-r">
										<div class="form-group">
											<div class="input-with-icon">
												<input type="text" class="form-control" placeholder="Brand Title or Keywords">
												<i class="ti-search"></i>
											</div>
										</div>
									</div>
		...
		<div class="company-brand">
			<div class="container">
				<div id="company-brands" class="owl-carousel">
					<div class="brand-img">
						<img src="client/assets/img/microsoft-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/img-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/mothercare-hom-darke.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/paypal-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/serv-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/xerox-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/yahoo-home-dark.png" class="img-responsive" alt="" />
					</div>
					<div class="brand-img">
						<img src="client/assets/img/mothercare-hom-darke.png" class="img-responsive" alt="" />
					</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="main-heading">
                        ...
                        <h2>Verified Online <span>Brands</span></h2></div>
                </div>
                <div class="row extra-mrg">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="full-time">Verified</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-2.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">Web Designing</a></h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-3.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-4.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">Software Developer</a></h4>
								<div class="instructor-skills">
									CSS3, HTML5, Javascript, Bootstrap, Jquery
								</div>
							</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-5.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							<div class="brows-job-type"><span class="part-time">Part Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-6.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">UI/UX Designer</a></h4>
								<div class="instructor-skills">
									CSS3, HTML5, Javascript, Bootstrap, Jquery
								</div>
							</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="full-time">Full Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-7.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">Content Writer</a></h4>
								<div class="instructor-skills">
									CSS3, HTML5, Javascript, Bootstrap, Jquery
								</div>
							</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">Project Manager</a></h4>
								<div class="instructor-skills">
									CSS3, HTML5, Javascript, Bootstrap, Jquery
								</div>
							</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="full-time">Full Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="client/assets/img/com-1.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
								<h4 class="instructor-title"><a href="job-detail.html">Wordpress Expert</a></h4>
								<div class="instructor-skills">
									CSS3, HTML5, Javascript, Bootstrap, Jquery
								</div>
							</div>
		...
		<!-- How it works video 
        <div class="clearfix"></div>
        <section class="video-sec dark" id="video" style="background-image:url(client/assets/img/banner-10.jpg);">
            <div class="container">
                <div class="row">
                    <div class="main-heading">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="client/assets/img/step-1.png" class="img-responsive" alt=""/><span class="process-num">01</span></span>
                            <h4>Create An Account</h4>
                            <p>Post your brand  to tell us about your what you do.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="client/assets/img/step-2.png" class="img-responsive" alt=""/><span class="process-num">02</span></span>
                            <h4>Search Jobs</h4>
                            <p>Post a job to tell us about your project. We'll quickly match you with the right freelancers find place best.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="client/assets/img/step-3.png" class="img-responsive" alt=""/><span class="process-num">03</span></span>
                            <h4>Save & Apply</h4>
                            <p>Post a job to tell us about your project. We'll quickly match you with the right freelancers find place best.</p>
                        </div>
                    </div>
        ...
        <section class="testimonial" id="testimonial">
            <div class="container">
                <div class="row">
                    <div class="main-heading">
                        <p>Brand Reviews</p>
                        <h2>Clients review <span>Stories</span></h2></div>
                </div>
                <div class="row">
                    <div id="client-testimonial-slider" class="owl-carousel">
                        <div class="client-testimonial">
                            <div class="pic"><img src="client/assets/img/client-1.jpg" alt=""></div>
                        ...
                        <div class="client-testimonial">
                            <div class="pic"><img src="client/assets/img/client-2.jpg" alt=""></div>
                            <p class="client-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor et dolore magna aliqua.</p>
                        ...
                        <div class="client-testimonial">
                            <div class="pic"><img src="client/assets/img/client-3.jpg" alt=""></div>
                            <p class="client-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor et dolore magna aliqua.</p>
        ...
        <!-- pricing Section Start 
								...
								<div class="top-candidate-box">
									...
									<div class="tp-candidate-inner-box">
										<div class="top-candidate-box-thumb">
											<img src="client/assets/img/can-5.jpg" class="img-responsive img-circle" alt="" />
										</div>
						...
						<div class="col-lg-12">
							...
							<div class="call-to-act">
								<div class="call-to-act-head">
									<h3>Unsure about the online vendor you want to buy from?</h3>
									<span>We'll help you find trusted and verified vendors online.</span>
								</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3">
								<div class="footer-widget">
									<img src="client/assets/img/logo-white.png" class="img-footer" alt="" />
			...
			<!-- Scripts
			================================================== -->
			<script type="text/javascript" src="client/assets/plugins/js/jquery.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/viewportchecker.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/bootstrap.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/bootsnav.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/select2.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/wysihtml5-0.3.0.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/bootstrap-wysihtml5.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/datedropper.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/dropzone.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/loader.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/owl.carousel.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/slick.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/gmap3.min.js"></script>
			<script type="text/javascript" src="client/assets/plugins/js/jquery.easy-autocomplete.min.js"></script>
			<!-- Custom Js -->
			<script src="client/assets/js/custom.js"></script><script type="text/javascript" src="client/assets/plugins/js/counterup.min.js"></script>
        <script src="client/assets/js/jQuery.style.switcher.js"></script>
...
<!-- Mirrored from codeminifier.com/job-stock-5.4.1/job-stock/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Oct 2021 06:58:47 GMT -->
</html>